...
const Title = () => {
  return (
    <Container>
      <header className="w-2/3 py-8">
        <h1 className="text-8xl font-ivarIta text-primary">
      ...
      <div className="flex flex-row gap-4 justify-around flex-wrap py-8">
        <img src="/images/Home1.png" alt="" className="w-2/5 h-auto" />

        <img src="/images/Home2.png" alt="" className="w-2/5 h-auto" />
      </div>
      <div className="w-2/3 py-8">
        <h2 className="text-6xl font-ivarReg text-primary">
